        ...
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <input id="email" name="email" type="text" value={email} onChange={ onChangeInputEmail }/>
            {
                email === '' ? 
                    null :
                    validEmail ? 
                        <FontAwesomeIcon icon={ faCheckCircle } style={ {marginLeft : 5, fontSize : 14, color : 'blue'} } /> :
                        <FontAwesomeIcon icon={ faTimesCircle } style={ {marginLeft : 5, fontSize : 14 ,color : 'red'} }/>
            }
